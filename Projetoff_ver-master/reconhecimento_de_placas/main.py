...
intervalo_frames = 1
frame_anterior = -8
output_folder = "C:\\Users\\Pichau\\Desktop\\Projetoff_ver-master\\img_placas_detectadas"
    ...
    for placa in placas_detectadas:
        ...
        if car_id != -1:
            ...
            if (0 <= x1 < frame.shape[1] and 0 <= x2 < frame.shape[1] and 0 <= y1 < frame.shape[0] and 0 <= y2 < frame.shape[0]):
                ...
                #Salvar a img da placa nao reconhecida para futura melhoria
                if(texto_detectado is None or texto_detectado is {}):
                    i = i + 1
